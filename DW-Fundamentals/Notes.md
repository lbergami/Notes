...
![Image Alt Text]("img/fact_table_keys.PNG") | In this example *student_key* and *date_key* make up together the primary key of the *tuition_bill_fact* table and each of them by itself are designated as foreign key: *student_key* is the PK of the *student_dim* table, while *date_key* is PK of the *date_dim* table
